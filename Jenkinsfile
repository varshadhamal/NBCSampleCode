    ...
    stages {
      ...
      stage('Deploy') {
          steps {
                   ...
                   sh "aws ecs register-task-definition --cli-input-json /var/lib/jenkins/workspace/R_java-maven-service_master-M6AVVQIQ3YEMNCS3COKAC7EMD3OJINHUMIE4VQURFG33I3EQFLNQ/sample.json --region us-west-2"
